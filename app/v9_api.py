...
def attach(app):
    try:
        ...
        main_module.APP_VERSION='9.2.2';main_module.ENGINE_VERSION='9.2';app.version='9.2.2'
    except Exception:
        pass
    ...
    def meta(authorization:Optional[str]=Header(None)):
        ...
        return {
            'version':'9.2.2','engine':'director-v9.2-style',
    ...
    def _create(x:V9JobIn,authorization:Optional[str]):
        ...
        with db() as c:
            ...
            settings={
                ...
                'directorMode':mode,'editIntensity':intensity,'hookStyle':hook,'visualStyle':visual,'studioVersion':'9.2.2',
            }
        ...
        return {'id':str(jid),'status':'queued','version':'9.2.2','directorMode':mode,'visualStyle':visual,'queueSignalled':signalled}
