...
def attach(app):
    try:
        ...
        main_module.APP_VERSION='10.0.0';main_module.ENGINE_VERSION='9.2';app.version='10.0.0'
    except Exception:
        pass
    ...
    def meta(authorization:Optional[str]=Header(None)):
        ...
        return {
            'version':'10.0.0','engine':'director-v9.2-style',
    ...
    def _create(x:V9JobIn,authorization:Optional[str]):
        ...
        with db() as c:
            ...
            settings={
                ...
                'directorMode':mode,'editIntensity':intensity,'hookStyle':hook,'visualStyle':visual,'studioVersion':'10.0.0',
            }
        ...
        return {'id':str(jid),'status':'queued','version':'10.0.0','directorMode':mode,'visualStyle':visual,'queueSignalled':signalled}
